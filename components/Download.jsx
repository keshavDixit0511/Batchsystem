...
const Download = () => {
  return (
    ...
    <div className='mx-auto px-28 bg-black relative text-white h-[70vh] my-20 overflow-hidden max-w-[78vw]'>
      <img className='absolute invert h-12 right-[25rem] top-20' src="/icons/star-1.png" alt="star" />

...
const Testimonials = () => {
  return (
    ...
    <div className='flex flex-col gap-5 items-center justify-center'>
        ...
        <h1 className='text-5xl ml-[5rem] font-black max-w-[26rem]'>What our Users say About Us?</h1>
    </div>
    
    <div className='flex items-center justify-center gap-x-48 h-screen max-w-screen overflow-hidden px-28'>
      ...
      <div className="text-persons flex flex-col">
      <div className='text max-w-[30vw]'>
        <div>

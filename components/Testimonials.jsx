...
const Testimonials = () => {
  return (
    <div className='relative mt-2 mb-5'>
      <img className='h-[35rem] absolute left-40 bottom-20 lg:block hidden' src="/icons/bg-gradient.png" alt="bg gradient" />
      <img className='h-12 sm:block hidden absolute left-[5rem] bottom-28' src="/icons/star-2.png" alt="" />
    <div className='flex flex-col gap-5 items-center justify-center'>
        <h1 className='uppercase font-semibold text-red-500'>Testimonial</h1>
        <h1 className='lg:text-5xl md:text-3xl sm:text-xl text-2xl ml-[1rem] lg:ml-[5rem] md:-ml-8 sm:-ml-10 font-black lg:max-w-[26rem] sm:max-w-[20rem] max-w-[30rem] md:max-w-[35rem]'>What our Users say About Us?</h1>
    </div>
    
    <div className='flex items-center justify-center gap-x-48 lg:h-screen h-full max-w-screen lg:max-w-screen  overflow-hidden px-10 sm:px-28 lg:px-28 md:px-10'>
        
      <div className='lg:h-[80vh] h-[80vh] w-2/5 hidden lg:block'>
      ...
      <div className='text max-w-[100vw] lg:max-w-[30vw] md:max-w-[60vw] sm:max-w-[90vw]'>
        <div>
            <div className="heading my-7">
                <h1 className='font-black text-base lg:text-3xl md:text-2xl sm:text-xl capitalize'>the best financial accounting app ever!</h1>
            </div>
            <p className='font-extralight text-base sm:text-xl text-gray-500'>“Arcu at dictum sapien, mollis. Vulputate sit id accumsan, ultricies. In ultrices malesuada elit mauris etiam odio. Duis tristique lacus, et blandit viverra nisl velit. Sed mattis rhoncus, diam suspendisse sit nunc, gravida eu. Lectus eget eget ac dolor neque lorem sapien, suspendisse aliquam.”</p>
        </div>
      </div>
      <div>

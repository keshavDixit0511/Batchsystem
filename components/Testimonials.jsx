...
const Testimonials = () => {
  return (
    ...
    <div className='flex flex-col gap-5 items-center justify-center'>
        ...
        <h1 className='lg:text-5xl md:text-3xl sm:text-xl text-2xl ml-[5rem] lg:ml-[5rem] md:-ml-8 sm:-ml-10 font-black lg:max-w-[26rem] max-w-[20rem] md:max-w-[35rem]'>What our Users say About Us?</h1>
    </div>
    
    <div className='flex items-center justify-center gap-x-48 h-screen lg:h-screen md:h-full sm:h-full max-w-screen lg:max-w-screen  overflow-hidden px-28 lg:px-28 md:px-10'>
        
      <div className='lg:h-[80vh] h-[80vh] w-2/5 md:hidden sm:hidden lg:block'>
      ...
      <div className='text max-w-[30vw] lg:max-w-[30vw] md:max-w-[60vw] sm:max-w-[90vw]'>
        <div>
            <div className="heading my-7">
                <h1 className='font-black text-3xl lg:text-3xl md:text-2xl sm:text-xl capitalize'>the best financial accounting app ever!</h1>
            </div>

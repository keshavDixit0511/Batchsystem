...
const Faqs = () => {
  return (
    <div className='px-6 md:px-16 lg:px-40 overflow-hidden mb-20 lg:mb-40'>
        <h1 className='text-lg md:text-xl text-red-500 mb-3'>FAQ</h1>
        <h1 className='text-3xl md:text-4xl lg:text-5xl font-black'>Frequently asked questions?</h1>
        <div className='flex flex-col md:flex-row gap-y-10 md:gap-x-16 h-full max-w-screen overflow-hidden px-2 mt-10'>

    ...
    <div className='flex flex-col lg:flex-row-reverse relative items-center justify-center gap-y-10 lg:gap-x-40 h-auto lg:h-screen max-w-screen overflow-hidden px-6 md:px-16 lg:px-24'>
      ...
      <div className='h-[60vh] md:h-[70vh] lg:h-[80vh] w-full lg:w-2/5'>
        <div className="relative z-10">
          <img className="absolute h-[30rem] md:h-[40rem] lg:h-[45rem] top-0 translate-x-0 lg:-translate-x-10  -translate-y-10 left-0  md:left-40 z-10" src="/icons/iPhone-13-Pro-Front-straight-2.png" alt="iPhone 13 Pro Front" />
        </div>

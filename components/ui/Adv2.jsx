...
const Adv2 = () => {
  return (
    <div className='flex relative items-center justify-center gap-x-40 h-screen max-w-screen overflow-hidden px-28'>
      <img className='h-12 absolute right-[10rem] bottom-12' src="/icons/star-1.png" alt="" />
      <div className='h-[80vh] w-2/5'>
        <div className="relative z-10 ">
          <img className="absolute h-[45rem] top-0 translate-x-28 -translate-y-3 left-0 z-10" src="/icons/iPhone-13-Pro-Front-straight-2.png" alt="iPhone 13 Pro Front" />
        </div>
      ...
      <div className='text max-w-[38vw]'>
        <div>
            <div className="logo-heading flex gap-x-4 items-center my-7">
                ...
                <h1 className='font-black text-3xl'>Fully customizable</h1>
            </div>
